...
In this coursework you will be making a Linked List template class.  As with the earlier pieces of coursework, it has two deadlines: one for the basics; and one for the advanced part.
...
(Note this has a later deadlines than the basic part of this assignment.)
